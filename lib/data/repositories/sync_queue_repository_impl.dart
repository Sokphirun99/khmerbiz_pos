...
class SyncQueueRepositoryImpl implements SyncQueueRepository {
  ...
  Stream<Either<Failure, int>> watchPendingCount() {
    ...
    }).handleError((err) => left<Failure, int>(CacheFailure.defaultError(details: err.toString())));
  }

  @override
  Future<Either<Failure, List<SyncQueueItem>>> getPendingItems({int limit = 10}) async {
    try {
  ...
  @override
  Future<Either<Failure, void>> markFailed(String id, String errorMessage) async {
    try {
